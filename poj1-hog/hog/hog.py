...
def boar_brawl(player_score, opponent_score):
    ...
    # BEGIN PROBLEM 2
    "*** YOUR CODE HERE ***"
    return max(abs(player_score % 10 - ten_digit(opponent_score)) * 3, 1)


def ten_digit(opponent_score):
    return (opponent_score // 10) % 10
    # END PROBLEM 2
...
def fuzzy_strategy(score, opponent_score, threshold=12, num_rolls=6):
    ...
    # BEGIN PROBLEM 11
    fuzzy_score = fuzzy_update(0, score, opponent_score)
    if fuzzy_score - score >= threshold:
        return 0
    return num_rolls  # Remove this line once implemented.
    # END PROBLEM 11
